function [activated_digraph, exchange_value, timed_out, core_exec_time] = restricted_edge_cycles_chains_solver(digraph_, max_edges_cycle, max_edges_chain, timeout_find_cycles_chains, timeout_solver, optimoptions)
    ...
    timer = tic;
    [activated_edge_indices, exchange_value, timed_out] = activate_maximizing_value(digraph_.Edges.Weight, inequality_matrix, inequality_vector, [], [], timeout_solver, optimoptions);
...
function [inequality_matrix, inequality_vector, timed_out] = get_inequality_constraints(digraph, max_edges_cycle, max_edges_chain, timeout_find_cycles_chains)
    [inequality_matrix_1, inequality_vector_1, timed_out] = get_disallowed_cycles_chains_constraints(digraph, max_edges_cycle, max_edges_chain, timeout_find_cycles_chains);
...
function [inequality_matrix, inequality_vector, timed_out] = get_disallowed_cycles_chains_constraints(digraph, max_edges_cycle, max_edges_chain, timeout)
