function [activated_digraphs, exchange_values, timed_outs, core_exec_times] = evaluate_solver_for_digraphs(digraphs, function_)
    ...
    for digraph_index = 1:length(digraphs)
        ...
        [activated_digraph, exchange_value, timed_out, core_exec_time] = function_(digraph);
