function [inequality_matrix, inequality_vector] = get_unrestricted_edge_digraph_constraints(digraph)
    [inequality_matrix_1, inequality_vector_1] = get_outdegree_minus_indegree_constraints(digraph);
    [inequality_matrix_2, inequality_vector_2] = get_indegree_constraints(digraph);
    [inequality_matrix_3, inequality_vector_3] = get_outdegree_constraints(digraph);
...
function [inequality_matrix, inequality_vector] = get_indegree_constraints(digraph)
    nodes_receiver = find(strcmp(digraph.Nodes.AgentType, 'trader') | strcmp(digraph.Nodes.AgentType, 'receiver'));
...
function [inequality_matrix, inequality_vector] = get_outdegree_constraints(digraph)
    nodes_donor_trader = find(strcmp(digraph.Nodes.AgentType, 'donor'));
