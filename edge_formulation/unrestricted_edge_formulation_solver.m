function [activated_digraph, exchange_value, timed_out] = unrestricted_edge_formulation_solver(digraph_, timeout)
    [inequality_matrix, inequality_vector] = get_unrestricted_edge_formulation_constraints(digraph_);
